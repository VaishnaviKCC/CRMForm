...
class gsp_Crm_accountshow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('all','f',22,['bean':("account")],-1)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(14)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.account)],3)
printHtmlPart(15)
...
invokeTag('form','g',28,['resource':(this.account),'method':("DELETE")],2)
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1464171367000L

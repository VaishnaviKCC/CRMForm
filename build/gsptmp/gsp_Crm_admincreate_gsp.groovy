...
class gsp_Crm_admincreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.admin),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.admin)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("admin")],-1)
printHtmlPart(20)

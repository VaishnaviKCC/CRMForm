...
class gsp_Crm_accountmylink_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/account/mylink.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(13)
invokeTag('table','f',23,['collection':(accountList)],-1)
printHtmlPart(14)
invokeTag('paginate','g',26,['total':(accountCount ?: 0)],-1)
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1464170201000L

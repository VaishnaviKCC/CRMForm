...
class gsp_Crm_adminshow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("admin")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.admin)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.admin),'method':("DELETE")],2)
printHtmlPart(17)
})

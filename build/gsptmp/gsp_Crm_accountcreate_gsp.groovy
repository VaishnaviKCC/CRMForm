...
class gsp_Crm_accountcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.account),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',27,['bean':(this.account)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('all','f',31,['bean':("account")],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1464170125000L
